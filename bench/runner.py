...
MCP_CONFIG = {
    ...
    "args": [str(PROJECT_ROOT / "mcp" / "zenripple_mcp_server.py")],
}

# All MCP tools the agent is allowed to use
ALLOWED_TOOLS = [
    "mcp__zenripple-browser__browser_create_tab",
    "mcp__zenripple-browser__browser_close_tab",
    "mcp__zenripple-browser__browser_switch_tab",
    "mcp__zenripple-browser__browser_list_tabs",
    "mcp__zenripple-browser__browser_navigate",
    "mcp__zenripple-browser__browser_go_back",
    "mcp__zenripple-browser__browser_go_forward",
    "mcp__zenripple-browser__browser_reload",
    "mcp__zenripple-browser__browser_get_page_info",
    "mcp__zenripple-browser__browser_screenshot",
    "mcp__zenripple-browser__browser_get_dom",
    "mcp__zenripple-browser__browser_get_page_text",
    "mcp__zenripple-browser__browser_get_page_html",
    "mcp__zenripple-browser__browser_click",
    "mcp__zenripple-browser__browser_click_coordinates",
    "mcp__zenripple-browser__browser_fill",
    "mcp__zenripple-browser__browser_select_option",
    "mcp__zenripple-browser__browser_type",
    "mcp__zenripple-browser__browser_press_key",
    "mcp__zenripple-browser__browser_scroll",
    "mcp__zenripple-browser__browser_hover",
    "mcp__zenripple-browser__browser_console_setup",
    "mcp__zenripple-browser__browser_console_teardown",
    "mcp__zenripple-browser__browser_console_logs",
    "mcp__zenripple-browser__browser_console_errors",
    "mcp__zenripple-browser__browser_console_eval",
    "mcp__zenripple-browser__browser_wait",
    "mcp__zenripple-browser__browser_wait_for_load",
    "mcp__zenripple-browser__browser_save_screenshot",
    "mcp__zenripple-browser__browser_list_frames",
    "mcp__zenripple-browser__browser_wait_for_element",
    "mcp__zenripple-browser__browser_wait_for_text",
    "mcp__zenripple-browser__browser_get_tab_events",
    "mcp__zenripple-browser__browser_get_dialogs",
    "mcp__zenripple-browser__browser_handle_dialog",
    "mcp__zenripple-browser__browser_get_navigation_status",
    "mcp__zenripple-browser__browser_clipboard_read",
    "mcp__zenripple-browser__browser_clipboard_write",
    # Phase 7: Data & Session
    "mcp__zenripple-browser__browser_get_cookies",
    "mcp__zenripple-browser__browser_set_cookie",
    "mcp__zenripple-browser__browser_delete_cookies",
    "mcp__zenripple-browser__browser_get_storage",
    "mcp__zenripple-browser__browser_set_storage",
    "mcp__zenripple-browser__browser_delete_storage",
    "mcp__zenripple-browser__browser_network_monitor_start",
    "mcp__zenripple-browser__browser_network_monitor_stop",
    "mcp__zenripple-browser__browser_network_get_log",
    "mcp__zenripple-browser__browser_intercept_add_rule",
    "mcp__zenripple-browser__browser_intercept_remove_rule",
    "mcp__zenripple-browser__browser_intercept_list_rules",
    "mcp__zenripple-browser__browser_session_save",
    "mcp__zenripple-browser__browser_session_restore",
    ...
    "mcp__zenripple-browser__browser_compare_tabs",
    "mcp__zenripple-browser__browser_batch_navigate",
    "mcp__zenripple-browser__browser_find_element_by_description",
    "mcp__zenripple-browser__browser_record_start",
    "mcp__zenripple-browser__browser_record_stop",
    "mcp__zenripple-browser__browser_record_save",
    "mcp__zenripple-browser__browser_record_replay",
    # Phase 10: Final Features
    "mcp__zenripple-browser__browser_drag",
    ...
    "mcp__zenripple-browser__browser_file_upload",
    "mcp__zenripple-browser__browser_wait_for_download",
